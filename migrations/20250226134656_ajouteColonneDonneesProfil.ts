...
type ProfilAvecEmailHash = Profil & { email_hash: string };
        ...
        .then((donneesEnClair) => {
          return trx("profils")
            ...
            .update({
              ...
              domaines_specialite: JSON.stringify(
                donneesEnClair.domaines_specialite,
              ),
